...
@Entity @Table(name="item_status_history") @Getter @NoArgsConstructor(access=AccessLevel.PROTECTED)
public class ItemStatusHistory {
 @Id @GeneratedValue(strategy=GenerationType.IDENTITY) @Column(name="item_status_history_id") private Long id;
