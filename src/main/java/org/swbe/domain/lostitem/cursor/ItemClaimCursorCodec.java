...
@Component
public class ItemClaimCursorCodec {
  ...
  public ItemClaimCursor decode(String cursor) {
    try {
      ...
      return new ItemClaimCursor(createdAt, id);
  ...
  private BusinessException invalidCursor() {
    return new BusinessException(ItemClaimErrorCode.INVALID_CURSOR);
  }
}
